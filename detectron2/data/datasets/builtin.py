...
def register_all_coco(root="/gdata/qith/datasets"):
...
def register_all_lvis(root="/gdata/qith/datasets"):
...
def register_all_cityscapes(root="/gdata/qith/datasets"):
...
def register_all_pascal_voc(root="/gdata/qith/datasets"):
    SPLITS = [
